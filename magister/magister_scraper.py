...
class Scraper:
    ...
    def __init__(self, username, password, school) -> bool:
        ...
        sleep(0.5)
        elem = self.driver.find_element(By.ID,"i0118")
        elem.clear()
    ...
    def rooster(self):
        ...
        elem = self.driver.find_element(By.ID,"menu-agenda")
        elem.click()
        time.sleep(2)
        ...
        for i in range(1, len(elems)+1):
            ...
            if class_name == "k-grouping-row ng-scope":
                ...
                elem3 = self.driver.find_element(By.XPATH,xpath3)
                txt = elem3.text

                vak, _, docent, _,_ = txt.split(" ")

                xpath4 = xpath + "/td[3]/span/span[3]"
                elem4 = self.driver.find_element(By.XPATH,xpath4)
                lokaal = elem4.text
    ...
    def cijfers(self):
        ...
        elem = self.driver.find_element(By.XPATH,cijverlijst_xpath)
        elems = elem.find_elements(By.TAG_NAME,'tr')
        ...
        for cijver_elem in elems:
            ...
            td_elems = cijver_elem.find_elements(By.TAG_NAME,'td')
